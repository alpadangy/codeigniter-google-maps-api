	...
	<script>
      function initMap() {
        ...
        var map = new google.maps.Map(mapDiv, {
          ...
          center: new google.maps.LatLng(<?php if (isset($edit_page_data)) { echo $edit_page_data->lat; } else {echo '10.8293448';} ?>, <?php if (isset($edit_page_data)) { echo $edit_page_data->lng; } else {echo '106.6704405';} ?>)
        });
